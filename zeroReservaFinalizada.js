...
document.querySelector(".contactos__solicitado").addEventListener("click", ()=>{//EL DEL NAV CONTACTA
    ...
    document.querySelector(".contenedor__caja__pago").style.opacity = "0.2";
    document.querySelector(".reserva__realizada").style.opacity = "0.2";
...
document.querySelector(".boton__contáctanos").addEventListener("click", ()=>{//EL DEL CONTÁCTANOS
    ...
    document.querySelector(".contenedor__contacto__contactanos").style.top = "400px";
})
